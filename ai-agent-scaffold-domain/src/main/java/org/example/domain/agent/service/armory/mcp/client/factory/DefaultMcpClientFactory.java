package org.example.domain.agent.service.armory.mcp.client.factory;

import jakarta.annotation.Resource;
import lombok.extern.slf4j.Slf4j;
import org.example.domain.agent.model.valobj.AIAgentConfigTableVO;
import org.example.domain.agent.service.armory.mcp.client.ToolMcpCreateService;
import org.example.domain.agent.service.armory.mcp.client.impl.LocalToolMcpCreateService;
import org.example.domain.agent.service.armory.mcp.client.impl.SSEToolMcpCreateService;
import org.example.domain.agent.service.armory.mcp.client.impl.StdioToolMcpCreateService;
